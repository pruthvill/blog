  ...
  return (
    <div className="pruthvil">
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 md:px-8">
        {/* Section title */}
        <h2 className="text-center text-lg font-bold mb-2">Desires</h2>
        {/* Content */}
        <div className="flex flex-col mx-auto">
          <ul className="flex flex-col gap-4">
            <li>
              ...
              <p className="">So, do what you want to do now because then you won't want to. It's okay to have wants that others don't understand.</p>
            </li>
          </ul>
        </div>
      </div>
